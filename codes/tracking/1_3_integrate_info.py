...
# python 1_3_integrate_info.py {fixed_track.tsv} {video_info.tsv} {fixed_track_final.tsv}

prefix = os.path.splitext(os.path.basename(sys.argv[1]))[0]
date = prefix.split('_')[0]

place = prefix.split('_')[2].split('-')[0]
strain = prefix.split('_')[2].split('-')[1]
sex = prefix.split('_')[2].split('-')[2]
age = prefix.split('_')[2].split('-')[3]
n_inds = prefix.split('_')[2].split('-')[4]
N = prefix.split('_')[2].split('-')[5]
